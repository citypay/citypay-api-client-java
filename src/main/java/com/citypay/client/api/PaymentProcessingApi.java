...
public class PaymentProcessingApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 422 </td><td> Unprocessable Entity. Should a failure occur that prevents processing of the API call. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request. Should the incoming data not be validly determined. </td><td>  -  </td></tr>
        <tr><td> 200 </td><td> A result and acknowledgement of the void request, returning an &#x60;080|003&#x60; response code on successful void/cancellation of the transaction. If an error occurs an error code will be returned explaining the failure.  </td><td>  -  </td></tr>
     </table>
     */
