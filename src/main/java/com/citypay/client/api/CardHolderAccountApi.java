...
public class CardHolderAccountApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Acknowledges the card has been requested for deletion. </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 422 </td><td> Unprocessable Entity. Should a failure occur that prevents processing of the API call. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request. Should the incoming data not be validly determined. </td><td>  -  </td></tr>
        <tr><td> 200 </td><td> Acknowledges the card status has changed, returning 01 for a valid change or 00 for non valid change. </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 422 </td><td> Unprocessable Entity. Should a failure occur that prevents processing of the API call. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request. Should the incoming data not be validly determined. </td><td>  -  </td></tr>
        <tr><td> 200 </td><td> An acknowledgment that the card holder account has been marked for deletion. </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 422 </td><td> Unprocessable Entity. Should a failure occur that prevents processing of the API call. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request. Should the incoming data not be validly determined. </td><td>  -  </td></tr>
        <tr><td> 200 </td><td> An acknowledgment that the card holder account status has been updated. </td><td>  -  </td></tr>
     </table>
     */
