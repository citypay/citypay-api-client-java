...
public class AuthReference {
  ...
  public AuthReference amount(Integer amount) {
  ...
  **/
  ...
  @ApiModelProperty(example = "3600", value = "The amount of the transaction in decimal currency format.")
  ...
  public AuthReference amountValue(String amountValue) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount of the transaction in integer/request format.")
