...
public class Batch {
  ...
  public Batch batchDate(@javax.annotation.Nonnull LocalDate batchDate) {
  ...
  public Batch batchId(@javax.annotation.Nullable Integer batchId) {
  ...
  public Batch batchStatus(@javax.annotation.Nonnull String batchStatus) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(batchDate, batchId, batchStatus, additionalProperties);
  }
