...
public class Card {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(binCommercial, binCorporate, binCountryIssued, binCredit, binCurrency, binDebit, binDescription, binEu, cardId, cardStatus, _default, expmonth, expyear, label, label2, last4digits, scheme, token);
  }
