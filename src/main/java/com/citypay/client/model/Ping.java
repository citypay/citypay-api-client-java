...
public class Ping {
  ...
  public Ping identifier(@javax.annotation.Nullable String identifier) {
   ...
   * @return the Ping instance itself
   */
  public Ping putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, ping.identifier)&&
        Objects.equals(this.additionalProperties, ping.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Ping>() {
           ...
           public Ping read(JsonReader in) throws IOException {
             ...
             Ping instance = thisAdapter.fromJsonTree(jsonObj);
