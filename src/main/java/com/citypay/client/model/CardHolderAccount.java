...
public class CardHolderAccount {
  ...
  **/
  ...
  public CardHolderAccount defaultCardIndex(String defaultCardIndex) {
  ...
  **/
  ...
  public void setDefaultCardIndex(String defaultCardIndex) {
    this.defaultCardIndex = defaultCardIndex;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, cards, contact, dateCreated, defaultCardId, defaultCardIndex, status, uniqueId);
  }
