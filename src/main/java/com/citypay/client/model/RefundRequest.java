...
public class RefundRequest {
  ...
  public RefundRequest amount(@javax.annotation.Nonnull Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public RefundRequest identifier(@javax.annotation.Nonnull String identifier) {
  ...
  public RefundRequest merchantid(@javax.annotation.Nonnull Integer merchantid) {
  ...
  public RefundRequest refundRef(@javax.annotation.Nonnull Integer refundRef) {
  ...
  public void setRefundRef(@javax.annotation.Nonnull Integer refundRef) {
    this.refundRef = refundRef;
  }


  public RefundRequest transInfo(@javax.annotation.Nullable String transInfo) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, identifier, merchantid, refundRef, transInfo, additionalProperties);
  }
