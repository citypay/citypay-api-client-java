...
public class PaylinkAttachmentRequest {
  ...
  **/
  ...
  @ApiModelProperty(value = "base64 encoding of the file if less than 32kb in size.")
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The name of the attachment normally taken from the filename. You should not include the filename path as appropriate.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The mime type of the attachment as defined in [RFC 9110](https://www.rfc-editor.org/rfc/rfc9110.html). Currently only `application/pdf` is supported.")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaylinkAttachmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
