...
/**
 * API tests for CardHolderAccountApiApi
 */
@Ignore
public class CardHolderAccountApiApiTest {

    private final CardHolderAccountApiApi api = new CardHolderAccountApiApi();
     ...
     */
    @Test
    public void accountExistsRequestTest() throws ApiException {
        String accountid = null;
        Exists response = api.accountExistsRequest(accountid);
