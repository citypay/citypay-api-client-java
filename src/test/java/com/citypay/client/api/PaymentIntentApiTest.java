 ...
 */
@Disabled
public class PaymentIntentApiTest {

    private final PaymentIntentApi api = new PaymentIntentApi();
    ...
    public void createPaymentIntentTest() throws ApiException {
        PaymentIntentRequestModel paymentIntentRequestModel = null;
        PaymentIntentReference response = api.createPaymentIntent(paymentIntentRequestModel);
    ...
    public void getPaymentIntentTest() throws ApiException {
        FindPaymentIntentRequest findPaymentIntentRequest = null;
        PaymentIntentResponseModel response = api.getPaymentIntent(findPaymentIntentRequest);
        // TODO: test validations
    }
