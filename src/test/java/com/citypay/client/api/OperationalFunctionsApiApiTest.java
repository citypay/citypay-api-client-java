...
/**
 * API tests for OperationalFunctionsApiApi
 */
@Ignore
public class OperationalFunctionsApiApiTest {

    private final OperationalFunctionsApiApi api = new OperationalFunctionsApiApi();
     ...
     */
    @Test
    public void aclCheckRequestTest() throws ApiException {
        AclCheckRequest aclCheckRequest = null;
        AclCheckResponseModel response = api.aclCheckRequest(aclCheckRequest);
     ...
     */
    @Test
    public void domainKeyCheckRequestTest() throws ApiException {
        DomainKeyCheckRequest domainKeyCheckRequest = null;
        DomainKeyResponse response = api.domainKeyCheckRequest(domainKeyCheckRequest);
     ...
     */
    @Test
    public void domainKeyGenRequestTest() throws ApiException {
        DomainKeyRequest domainKeyRequest = null;
        DomainKeyResponse response = api.domainKeyGenRequest(domainKeyRequest);
