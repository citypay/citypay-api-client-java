...
public class ApiKeyTest {
    ...
    @Test
    public void testGenerate() throws NoSuchAlgorithmException, InvalidKeyException, IOException {
        String key = ApiKey.create("PC2", "7G79TG62BAJTK669",
                hexStringToByteArray("acb875aef083de292299bd69fcdeb5c5"),
                LocalDateTime.parse("2020-01-01T09:23:12")

        );
        assertEquals(key, "UEMyOkFDQjg3NUFFRjA4M0RFMjkyMjk5QkQ2OUZDREVCNUM1Ol6Q3tCMPsYvqNhFelRD2zQHYlZquBGCY/6ZpZ0AngTF");
    }

    @Test
    public void testApiData() throws NoSuchAlgorithmException, InvalidKeyException, IOException {
        String[][] data = {
        ...
        for (String[] datum : data) {
            String key = ApiKey.create(
                    datum[0],
                    datum[1],
                    hexStringToByteArray(datum[2]),
                    LocalDateTime.parse(datum[3])
            );
            assertEquals(datum[4], key);
        }
